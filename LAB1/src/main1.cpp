...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model_tree1 = glm::translate(model_tree1, glm::vec3(-30.0f, 0.0f, -20.0f));
        ...
        model_tree2 = glm::translate(model_tree2, glm::vec3(30.0f, 0.0f, 20.0f));
        ...
        model_ground = glm::translate(model_ground, glm::vec3(0.0f, 0.0f, 20.0f));
        model_ground = glm::scale(model_ground, glm::vec3(100.0f, 1.0f, 120.0f));
        drawModel("Cube", model_ground, view, projection, 10, 51, 0);
